"""
{{STORE_NAME}} — Product Update Script
===================================
Drop your ONHAND CSV into the {{STORE_FOLDER_NAME}} folder as "onhand.csv" and run:
...
def main():
    ...
    if not os.path.exists(csv_path):
        print("=" * 60)
        print("  {{STORE_NAME}} — Product Updater")
        print("=" * 60)
        print()
    ...
    if ans in ("y", "yes"):
        ...
        print("\n  [OK] Deployed! Check https://{{DOMAIN_NAME}}")
    else:
