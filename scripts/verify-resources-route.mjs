...
const publicCopy = [resourceData, homePage, footer, seoPages].join("\n").toLowerCase();
const bannedPhrases = [
  "keyword coverage",
...
console.log(`[verify-resources] OK: ${routeMatches.length} KLC Resource routes checked.`);
