...
const chat = await readFile(new URL("../app/delivery/KLCWebChat.tsx", import.meta.url), "utf8");
...
assert.ok(delivery.includes("<KLCWebChat />"), "Delivery page must render Kennedy Loud Cannabis Web Chat");
...
console.log("Kennedy Loud Cannabis consent Web Chat contract passed.");
