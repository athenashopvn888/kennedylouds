...
export const TIER_SEO: Record<string, TierSeoData> = {
  ...
  PREMIUM: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "At Kennedy Loud Cannabis on Brampton St, our Premium tier offers the best quality-to-price ratio in the neighbourhood. Every strain in this tier has been personally vetted by our team for potency, flavour, and bag appeal.",
      },
    ],
    faqs: [
  ...
  BUDGET: {
    ...
    seoIntro: "Cheap weed in Brampton starting at $3/g. Kennedy Loud Cannabis Budget tier features shreds and value ounces for cost-conscious smokers. Open daily on Brampton St.",
    sections: [
      {
