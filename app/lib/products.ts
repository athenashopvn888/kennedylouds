...
export const CATEGORY_CONFIG: Record<string, CategoryInfo> = {
  EDIBLES: {
    ...
    faqs: [
      ...
      { q: "Can I buy edibles at Kennedy Loud Cannabis?", a: "Yes! Visit us at 49 Hillcrest Ave, Unit 104, Brampton. We're open daily 24 hours with a full edibles selection in store." },
    ],
  },
  "VAPE PENS": {
    ...
    seoIntro: "Shop THC and nicotine vape pens at Kennedy Loud Cannabis, Brampton. Cartridges, 510-thread batteries, and premium vape brands — all in stock.",
    seoDescription: "Kennedy Loud Cannabis carries a curated selection of vape pens and cartridges in Brampton. From 510-thread THC cartridges to nicotine vape pods, we stock the most popular brands and flavours. Our knowledgeable budtenders can help you choose the right cartridge and battery setup. Visit us at 49 Hillcrest Ave, Unit 104 for the best vape selection in Brampton.",
    faqs: [
  ...
  "VAPE DISPOSABLE": {
    ...
    seoIntro: "THC disposable vapes available at Kennedy Loud Cannabis, Brampton. No charging, no refilling — just open and enjoy.",
    seoDescription: "Disposable THC vapes are the easiest way to enjoy cannabis on the go. Kennedy Loud Cannabis stocks a wide selection of pre-charged, pre-filled disposable vape pens with various strain profiles and potencies. Perfect for beginners and experienced users alike. Visit us at 49 Hillcrest Ave, Unit 104, Brampton.",
    faqs: [
  ...
  CONCENTRATES: {
    ...
    seoIntro: "Premium cannabis concentrates at Kennedy Loud Cannabis, Brampton. Shatter, wax, hash, live resin, and diamonds — all in stock.",
    seoDescription: "Kennedy Loud Cannabis offers a premium selection of cannabis concentrates in Brampton. From traditional hash and kief to modern extracts like shatter, wax, live resin, and THC diamonds, we carry products for every preference and potency level. Our concentrates are sourced from trusted extractors and tested for purity. Visit us at 49 Hillcrest Ave, Unit 104.",
    faqs: [
  ...
  PREROLLS: {
    ...
    seoIntro: "Pre-rolled cannabis joints at Kennedy Loud Cannabis, Brampton. Singles, multi-packs, and infused pre-rolls — ready to light up.",
    seoDescription: "Skip the rolling and grab a pre-roll from Kennedy Loud Cannabis in Brampton. We carry singles, multi-packs, and infused pre-rolls from premium flower. Whether you want a quick smoke or a party pack, our pre-roll selection has something for everyone. Visit us at 49 Hillcrest Ave, Unit 104 — open daily 24 hours.",
    faqs: [
  ...
  "ADD ONS": {
    ...
    seoIntro: "Essential cannabis accessories at Kennedy Loud Cannabis, Brampton. Grinders, rolling papers, lighters, trays, and more.",
    seoDescription: "Kennedy Loud Cannabis carries all the accessories you need for the perfect smoke session. From premium grinders and rolling papers to lighters, trays, and storage containers, we have everything in stock. Visit us at 49 Hillcrest Ave, Unit 104, Brampton.",
    faqs: [
  ...
  "MAGIC & OTHERS": {
    ...
    seoIntro: "Magic mushrooms, psilocybin products, and specialty items at Kennedy Loud Cannabis, Brampton.",
    seoDescription: "Kennedy Loud Cannabis carries a curated selection of magic mushrooms and specialty products in Brampton. From micro-dose capsules to dried psilocybin mushrooms, we stock products for both beginners and experienced psychonauts. Visit us at 49 Hillcrest Ave, Unit 104 for our full selection.",
    faqs: [
