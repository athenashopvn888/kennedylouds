...
export function getItemData(category: string, name: string): ItemEffects {
  ...
  return {
    effects: menuNotes,
    description: `${name} appears in the ${categoryLabel} category at Kennedy Loud Cannabis. Review the current menu and package details before visiting.`,
    metaDescription: `Review ${name} menu information at Kennedy Loud Cannabis in Brampton. Check current details before visiting.`,
