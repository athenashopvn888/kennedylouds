...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    ...
    "title": "How to Plan a Kennedy Loud Cannabis Visit Without Guessing",
    "seoTitle": "Kennedy Loud Cannabis Visit Guide | Weed Dispensary in Brampton",
    "seo_title": "Kennedy Loud Cannabis Visit Guide | Weed Dispensary in Brampton",
    "metaDescription": "Plan a Kennedy Road in Brampton visit to Kennedy Loud Cannabis with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "meta_description": "Plan a Kennedy Road in Brampton visit to Kennedy Loud Cannabis with a clear shopper checklist for store details, menu categories, current listings, and staff questions.",
    "h1": "How to Plan a Kennedy Loud Cannabis Visit Without Guessing",
    "excerpt": "A practical visit guide for Kennedy Loud Cannabis, written for shoppers who want the next step without the runaround.",
    "author": "Kenny Loud",
  ...
  },
  {
    ...
    "title": "How to Compare Kennedy Loud Cannabis Flower Without Guessing",
    "seoTitle": "Kennedy Loud Cannabis Flower Guide | Budget to Exotic",
    "seo_title": "Kennedy Loud Cannabis Flower Guide | Budget to Exotic",
    "metaDescription": "Compare Kennedy Loud Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "meta_description": "Compare Kennedy Loud Cannabis flower sections with natural guidance for cheap weed, budget weed, premium flower, exotic flower, and current menu checks.",
    "h1": "How to Compare Kennedy Loud Cannabis Flower Without Guessing",
    "excerpt": "A shopper-first flower guide for comparing Budget, AA, AAA+, Premium, and Exotic sections at Kennedy Loud Cannabis.",
    "author": "Rhea Kennedy",
    "authorName": "Rhea Kennedy",
    "authorHandle": "@RheaLouds",
    "authorRole": "House Writer",
  ...
  },
  {
    ...
    "title": "How to Shop the Kennedy Loud Cannabis Menu Like a Pro",
    "seoTitle": "Kennedy Loud Cannabis Menu Guide | Brampton Weed Store",
    "seo_title": "Kennedy Loud Cannabis Menu Guide | Brampton Weed Store",
    "metaDescription": "Shop the Kennedy Loud Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "meta_description": "Shop the Kennedy Loud Cannabis menu with a simple shopper-first guide to flower, pre-rolls, edibles, THC vapes, concentrates, and current listings.",
    "h1": "How to Shop the Kennedy Loud Cannabis Menu Like a Pro",
    "excerpt": "A natural guide to shopping the Kennedy Loud Cannabis menu without turning the visit into a guessing game.",
    "author": "Kenny Loud",
    "authorName": "Kenny Loud",
    "authorHandle": "@KennyOnKennedy",
    "authorRole": "House Writer",
