...
const STATIC_POSTS = [
  ...
  },
  {
    ...
    title: "Why Kennedy Loud Cannabis is Brampton's Best Dispensary",
...
export default function BlogContent() {
  ...
  useEffect(() => {
    fetch(`${APPS_SCRIPT_URL}?action=blog&store=KLC01`)
      .then((r) => r.json())
  ...
  return (
    <main className={styles.main}>
      ...
      <section style={{ width: "100%", overflow: "hidden", marginTop: "92px" }}>
        <img
          src="/banners/KennedyLoud_Blog.webp"
          alt="Kennedy Loud Cannabis Blog"
