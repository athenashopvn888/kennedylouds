...
function getJsonLd(flower: FlowerProduct) {
  ...
  const offers: any = {
    "@type": "Offer",
    url: `https://kennedyloudcannabis.com/flower/${flower.slug}`,
    priceCurrency: "CAD",
  ...
  return {
    ...
    "@type": "Product",
    name: flower.name,
    image: flower.image ? [flower.image.startsWith('http') ? flower.image : `https://kennedyloudcannabis.com${flower.image.startsWith('/') ? '' : '/'}${flower.image}`] : undefined,
    description: strainData.description,
    brand: { "@type": "Brand", name: "Kennedy Loud Cannabis" },
  ...
  return {
    ...
    "itemListElement": [
      ...
      },
      {
        ...
        "position": 2,
        "name": tierName,
        "item": `https://kennedyloudcannabis.com/${tierSlug}`
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": flower.name,
        "item": `https://kennedyloudcannabis.com/flower/${flower.slug}`
      }
    ]
  };
}
              ...
              <div className={styles.pricingSection}>
                ...
                {bestValue && (
                  <div className={styles.valueNote}>
                    Per-gram note: <strong>${bestValue.perG}/g</strong> at {bestValue.label}
                  </div>
                )}
              </div>
