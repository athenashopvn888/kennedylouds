...
const RESOURCE_LINKS = [
  ...
  },
  {
    ...
    body: "Exotic Weed, Premium Weed, AAA+ Weed, AA Weed, and Budget Weed in one guide.",
  },
];
...
const LOCAL_FAQS = [
  {
    ...
    a: `Kennedy Loud Cannabis at ${NAP.address} is Open 24 Hours a day, 7 days a week. Walk in anytime - no appointment needed.`,
  },
  {
  ...
  },
  {
    ...
    a: `We are located at ${NAP.address}. Visit us in person or call us at ${NAP.phone}. Check posted signs or the map listing for parking details.`,
  },
  {
    ...
    <main className={styles.main}>
      ...
      <section className={styles.localVisitStrip} aria-label="Kennedy Loud Cannabis visit details">
        <div className={styles.localVisitInner}>
          <div>
            <span className={styles.localVisitEyebrow}>Walk-in Brampton dispensary</span>
            <p className={styles.localVisitAddress}>{NAP.address}</p>
            <p className={styles.localVisitMeta}>
              <span>{NAP.hours}</span>
              <a href={`tel:${NAP.phoneIntl}`}>{NAP.phone}</a>
              <span>Hillcrest Ave · Kennedy Road</span>
            </p>
          </div>
          <div className={styles.localVisitActions}>
            <a href={`tel:${NAP.phoneIntl}`} className={styles.localVisitPrimary}>Call Store</a>
            <a
              href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(NAP.address)}`}
              className={styles.localVisitSecondary}
              target="_blank"
              rel="noreferrer"
            >
              Directions
      ...
      <section className={styles.welcomeBannerSection}>
        <div className={styles.welcomeBannerContainer}>
          <img
            ...
            alt="Welcome to Kennedy Loud Cannabis, a 24 hour weed dispensary in Brampton"
        ...
        <div className={styles.container}>
          <div className={styles.seoPanel}>
            ...
            <p className={styles.seoPanelText}>
              <strong>Kennedy Loud Cannabis</strong> is listed at {NAP.address}. The site is organized around flower tiers, edibles, pre-rolls, vapes, concentrates, cigarettes, accessories, and specialty categories.
            </p>
            <p className={styles.seoPanelText}>
        ...
        <div className={styles.container}>
          <div className={styles.storeGrid}>
            ...
            <div className={styles.storeCard}>
              ...
              <p className={styles.storeCardText}>
                <a href={`tel:${NAP.phoneIntl}`} className={styles.storeLink}>{NAP.phone}</a>
                <br />
                <span className={styles.storeHighlight}>Call before a special-item trip</span>
              </p>
            </div>
            <div className={styles.storeCard}>
              ...
              <p className={styles.storeCardText}>
                Open 7 Days a Week
                <br />
                <span className={styles.storeHighlight}>{NAP.hours}</span>
              </p>
            </div>
            <div className={styles.storeCard}>
              <h3 className={styles.storeCardTitle}>Website</h3>
              <p className={styles.storeCardText}>
                <a href={NAP.website} className={styles.storeLink}>{NAP.website}</a>
                <br />
          ...
          <div className={styles.mapWrap}>
            <iframe
              title="Map of Kennedy Loud Cannabis in Brampton"
              src={`https://maps.google.com/maps?q=${encodeURIComponent(NAP.address)}&z=16&output=embed`}
              loading="lazy"
              referrerPolicy="no-referrer-when-downgrade"
              style={{ width: "100%", minHeight: 280, border: 0, display: "block" }}
            />
          </div>
        </div>
      </section>
